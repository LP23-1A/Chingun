...
export default function Home() {
  return (
    <main className='inline-flex pb-[543px] flex-col justify-center items-center mx-auto'>
      <div className='flex flex-col items-start gap-[100px]'>
        <Navbar></Navbar>
        <div className='flex h-[3005px] flex-col items-center gap-[100px] px-[330px] mx-auto'>
