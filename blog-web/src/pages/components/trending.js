...
const Trending = ({ children }) => {
    return (
        <div className='flex w-[293px] h-[320px] flex-col items-start rounded-xl'>
            ...
            <div className="flex w-[230px] h-[120px] flex-col items-start gap-4 absolute ">
                <Badge>Technology</Badge>
                <text className="text-white text-lg not-italic font-semibold leading-7; font-family: Work Sans;">The Impact of Technology on the Workplace: How Technology is Changing</text>
            </div>
        </div>
